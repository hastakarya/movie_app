    ...
    <div class="container mx-auto px-4 pt-16">
        <div class="popular-movies">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                @foreach ($popularMovies['results'] as $popularMovie)
                    <div class="mt-8">
                        <a href="">
                            <img src="{{ 'http://image.tmdb.org/t/p/w780/'.$popularMovie['backdrop_path'] }}" alt="" class="hover:opacity-75 transition ease-in-out duration-150">
                        </a>
                        <div class="mt-2">
        ...
        <div class="now-playing-movies py-24">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                <div class="mt-8">
                    <a href="">
                        <img src="{{asset('img/movie1.jpg')}}" alt="" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                    <div class="mt-2">
